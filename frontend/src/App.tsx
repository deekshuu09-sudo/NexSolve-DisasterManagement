...
export function App() {
  ...
  const broadcastWarning = () => {
    ...
    let speechText = ''
    if (level === 'RED') {
      speechText = `NexSolve decision support notice for ${districtName}. Current modeled risk score is ${score} out of 100. Decision status: Red, emergency level prototype decision.`
  ...
  return (
    <div className="app-shell">
      ...
      {/* Non-official Prototype Disclaimer */}
      <div className="disclaimer-banner">
        <strong>NON-OFFICIAL SIH PROTOTYPE:</strong> NexSolve decision support outputs are generated by an experimental Random Forest ML model for evaluation purposes only. Official emergency operations must rely on Survey of India, IMD, and NDMA alerts.
      </div>
      ...
      <footer className="footer-bar">
        <span>NexSolve Disaster Management © 2026 — Smart India Hackathon Prototype</span>
